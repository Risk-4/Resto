...
<div class="data">
    <table border="1" width="80%" cellpading="0" cellspacing="0">
        <tr>
            <td>No</td>
            <td>Nama Kategori</td>
            <td>Edit</td>
        ...
        <?php 
            ...
            foreach($data as $row){
                ...
                <tr>
                    ...
                    <td>
                        <a onclick="return confirm('yakin mau dihapus?');" class="btn-hapus" href="?hal=kategori&id=<?=$row['idkategori']?>"><i class="fa fa-trash"></i>Hapus</a>
                    </td>
                </tr>
                <?php
            }
